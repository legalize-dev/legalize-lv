...
status: "repealed"
source: "https://likumi.lv/ta/id/317283"
...
op_number: "2020/177.8"
---
# Zaudējis spēku - Fonda kopējā riska un riska darījumu apmēra ar darījumu partneri aprēķināšanas normatīvie noteikumi

Finanšu un kapitāla tirgus komisijas normatīvie noteikumi Nr. 147Rīgā 2020. gada 1. septembrī(Finanšu un kapitāla tirgus komisijas padomessēdes protokols Nr. 36 8. p.)

Izdoti saskaņā ar Ieguldījumu pārvaldessabiedrību likuma 66. panta 8.1 daļu
...
##### 11. Izmantojot relatīvo RPV metodi, ieguldījumu portfeļa RPV nedrīkst pārsniegt atsauces ieguldījumu portfeļa, kas minēts šo noteikumu IV sadaļas 1. daļā, RPV vairāk kā divas reizes.
...
23.1. obligāciju iespējas līgumiem – līguma nosacīto pamatvērtību (notional contract value) reizina ar atsauces bāzes aktīva obligācijas tirgus vērtību un delta koeficientu (delta koeficients ir koeficients, kas parāda, kādā mērā mainās iespējas līguma vērtība, mainoties bāzes aktīva cenai);
...
26.1. konvertējamajām obligācijām (convertable bonds) atsauces bāzes aktīva tirgus vērtību reizina ar delta koeficientu;
...
##### 42. Fonda kopējā riska aprēķinā drīkst neiekļaut arī AFI, ja ir ievērotas abas turpmāk minētās prasības:
...
##### 43. Strukturētā fonda, kurš atbilst visiem turpmāk minētajiem kritērijiem, kopējo risku drīkst aprēķināt saskaņā ar saistību metodi, ņemot vērā šo noteikumu 44. punktā noteiktās prasības:
...
43.7. maksimālais apmērs, ko iespējams zaudēt brīdī, kad fonda ieguldītājiem izmaksājamās peļņas shēma tiek mainīta pret citu, nepārsniedz 100% no sākotnējā ieguldījuma vērtības;
...
44.1. saskaņā ar noteiktu formulu īstenotā fonda ieguldījumu stratēģija katrai iepriekš noteiktajai izmaksājamajai peļņai tiek iedalīta atsevišķos izmaksājamās peļņas scenārijos;
...
##### 69. Sabiedrība nodrošina, ka tās amatpersonas regulāri, bet ne retāk kā reizi ceturksnī saņem informāciju par atpakaļejošo pārbaužu rezultātiem, ja pārsniegumu skaits fondam pēdējo 250 darba dienu laikā ir lielāks par četriem ar ticamības intervālu 99%. Informācija ietver analīzi un skaidrojumu par pārsniegumu iemesliem un ziņojumu par pasākumiem, kādi veikti modeļa precizitātes uzlabošanai.
...
##### 71. Sabiedrība, kas izmanto fonda kopējā riska aprēķinam RPV metodi, ņemot vērā fonda definēto riska profilu, nodrošina pienācīgu, visaptverošu un riskam atbilstošu stresa testēšanas procesu, ievērojot šajā daļā minētās prasības.
...
##### 74. Stresa testi aptver visus riskus, kuri var būtiski ietekmēt ieguldījumu portfeļa vērtību vai vērtības svārstības. Īpaši ņem vērā riskus, kuri nav pilnībā ietverti izmantotajā RPV modelī.
...
83.8. pastāvīgi veikt un dokumentēt RPV modeļa apstiprināšanu (ongoing validation), kas ietver arī atpakaļejošās pārbaudes saskaņā ar šīs sadaļas 5. daļu, lai nodrošinātu, ka modelis ir precīzi kalibrēts un tajā izmantotie pieņēmumi ir pamatoti. RPV modeļa apstiprināšanai sabiedrība izstrādā procedūru, kurā nosaka arī to, kādos gadījumos, ņemot vērā modeļa apstiprināšanas rezultātus, nepieciešams modeli koriģēt.
...
102.5. akciju aizdošanas darījuma vai pārdošanas ar atpirkšanu darījuma gadījumā – tīro riska darījumu ar šo darījumu partneri vērtību.
...
### VII sadaļaNoslēguma jautājums

##### 111. Ar šo noteikumu spēkā stāšanos spēku zaudē Komisijas 11.11.2011. normatīvie noteikumi Nr. 242 "Fonda kopējā riska un riska darījumu apmēra ar darījumu partneri aprēķināšanas normatīvie noteikumi".
...
4) Eiropas Vērtspapīru un tirgu iestādes (ESMA) vadlīnijām (ESMA/2012/197) kompetentajām iestādēm un PVKIU ieguldījumu pārvaldes sabiedrībām par riska novērtēšanu un kopējā riska aprēķināšanu noteikta veida strukturētiem fondiem.

**Finanšu un kapitāla tirguskomisijas priekšsēdētājaS. Purgaile**
