...
status: "repealed"
source: "https://likumi.lv/ta/id/320119"
...
##### 29. Sabiedrība īsteno tādu likviditātes riska kontroles procesu, lai katram pārvaldīšanā esošajam atvērtajam ieguldījumu fondam nodrošinātu ieguldījumu apliecību atpakaļpirkšanas prasības ievērošanu. Lai novērtētu likviditātes risku ārkārtas situācijās, sabiedrība veic fonda darbības raksturam, apjomam un sarežģītībai atbilstošu stresa testēšanu, ievērojot Eiropas Vērtspapīru un tirgu iestādes pamatnostādnēs "Par PVKIU un AIF likviditātes stresa testiem" (ESMA34-39-897) noteiktās prasības.
...
### III1. Sabiedrības kapitāla pietiekamības novērtēšanas process

##### 31.1 Kapitāla pietiekamības novērtēšanas procesa mērķis ir nodrošināt, ka sabiedrības kapitāls apmēra, elementu un to īpatsvara ziņā ir atbilstošs Ieguldījumu pārvaldes sabiedrību likuma 8. pantā noteiktajām prasībām un ietver sabiedrības kapitāla plānošanu un risku segšanai pietiekama kapitāla apmēra pastāvīgu uzturēšanu.

##### 31.2 Sabiedrība izstrādā, dokumentē un īsteno efektīvu un pamatotu kapitāla pietiekamības novērtēšanas procesa politiku un procedūras, kurās nosaka:

31.21. kapitāla apmēra aprēķināšanas kārtību atbilstoši normatīvo aktu prasībām;

31.22. metodes, ko sabiedrība izmanto, lai noteiktu un pastāvīgi uzturētu pietiekamu kapitāla apmēru;

31.23. stresa testu veikšanas kārtību un regularitāti;

31.24. pienākumu, pilnvaru un atbildības sadalījumu kapitāla pietiekamības novērtēšanas procesa veikšanā;

31.25. pārskatu par kapitāla pietiekamības novērtēšanas procesa rezultātiem sniegšanas kārtību, kas nodrošina, ka sabiedrības padome un valde regulāri saņem informāciju, kura ļauj novērtēt sabiedrības kapitāla pietiekamību, kā arī citu lēmumu pieņemšanai nepieciešamo informāciju;

31.26. kapitāla pietiekamības novērtēšanas procesa regularitāti.

##### 31.3 Sabiedrība regulāri, bet ne retāk kā reizi gadā pārskata un pilnveido kapitāla pietiekamības novērtēšanas procesa politiku un procedūras atbilstoši pārmaiņām sabiedrības darbībā un sabiedrības darbību ietekmējošajos ārējos apstākļos.

### IV. Sabiedrības padomes funkcijas iekšējās kontroles sistēmas jomā

##### 32. Sabiedrības padome uzrauga, kā sabiedrības valde nodrošina iekšējās kontroles sistēmas izveidi un efektīvu funkcionēšanu, kā arī ilgtspējas risku integrēšanu tajā. Iekšējās kontroles sistēmas jomā sabiedrības padome:
...
32.8. pārrauga efektīvas vadības informācijas sistēmas funkcionēšanu, kā arī ilgtspējas risku integrēšanu tajā;
...
### V. Sabiedrības valdes funkcijas iekšējās kontroles sistēmas jomā

##### 33. Sabiedrības valde ir atbildīga par visaptverošas iekšējās kontroles sistēmas izveidošanu, tās īstenošanu, pārvaldīšanu un pilnveidošanu, kā arī ilgtspējas risku integrēšanu tajā. Iekšējās kontroles sistēmas jomā sabiedrības valde:
...
### VI. Iekšējās kontroles funkcijas
...
41.5. Komisijas fonda kopējā riska un riska darījumu apmēra ar darījumu partneri aprēķināšanas normatīvajos noteikumos noteikto pienākumu veikšanu attiecībā uz riskam pakļautās vērtības metodes izmantošanu;
...
##### 55. Ar šo noteikumu spēkā stāšanos spēku zaudē Komisijas 11.11.2011. normatīvie noteikumi Nr. 246 "Ieguldījumu pārvaldes sabiedrību iekšējās kontroles sistēmas izveides normatīvie noteikumi".
...
4) Eiropas Parlamenta un Padomes 21.05.2013. Direktīvas 2013/14/ES, ar ko groza Direktīvu 2003/41/EK par papildpensijas kapitāla uzkrāšanas institūciju darbību un uzraudzību, Direktīvu 2009/65/EK par normatīvo un administratīvo aktu koordināciju attiecībā uz pārvedamu vērtspapīru kolektīvo ieguldījumu uzņēmumiem (PVKIU) un Direktīvu 2011/61/ES par alternatīvo ieguldījumu fondu pārvaldniekiem attiecībā uz pārmērīgu paļaušanos uz kredītreitingiem;

5) Eiropas Vērtspapīru un tirgu iestādes dokumenta "Pamatnostādnes par PVKIU un AIF likviditātes stresa testiem" ("Guidelines on liquidity stress testing in UCITS and AIFs", ESMA34-39-897);

6) Komisijas 21.04.2021. Deleģētās direktīvas (ES) 2021/1270, ar ko Direktīvu 2010/43/ES groza attiecībā uz ilgtspējas riskiem un ilgtspējas faktoriem, kas jāņem vērā attiecībā uz pārvedamu vērtspapīru kolektīvo ieguldījumu uzņēmumiem (PVKIU).
